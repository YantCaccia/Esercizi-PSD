/*Crea una lista e vi inserisce solo i nodi dell'albero che hanno almeno un figlio*/
#include "btree.h"
#include <stdio.h>
#include <stdlib.h>
#include "item.h"
...
void balanced(Btree *tree, char *x, Item *arr, int inizio, int fine) {
    ...
    balanced(&(*tree)->left, "l", arr, inizio, n);
    balanced(&(*tree)->right, "r", arr + n + 1, 0, n - n / 2);
}
